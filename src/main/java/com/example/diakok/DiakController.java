...
*/
    ...
    protected void onEveryoneButtonClick() {
        ObservableList<String> content = FXCollections.observableArrayList(
                query_students_by_filter((Student _) -> true)
        );
    ...
    protected void onSandorButtonClick() {
        ObservableList<String> content = FXCollections.observableArrayList(
                query_students_by_filter((Student student) -> student.getKnev().equals("Sándor"))
        );
        people_list.setItems(content);
    }
    ...
    protected void onKecskemetButtonClick() {
        ObservableList<String> content = FXCollections.observableArrayList(
                query_students_by_filter((Student student) -> student.getPlaceOfLiving().equals("Kecskemét"))
        );
        people_list.setItems(content);
    }
    ...
    protected void onFrom1996Click() {
        ObservableList<String> content = FXCollections.observableArrayList(
                query_students_by_filter((Student student) -> student.getBirthdate().startsWith("1996"))
        );
        people_list.setItems(content);
    }
    ...
    protected void onPartOf10AButtonClick() {
        ObservableList<String> content = FXCollections.observableArrayList(
                query_students_by_filter((Student student) -> student.getSchoolclass().equals("10/A"))
        );
        people_list.setItems(content);
    }
